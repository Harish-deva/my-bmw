...
ariaLabelledBy:f,ariaLive:"off"})}setTimeout(function(){a.accessibility.focusFirstFocusableChild(a.$tooltipContainer)},300)}};h.prototype.addListenersToTooltip=function(a){0!==a.$closeButton.length&&(a.accessibility.addKeyListener("up",{element:a.$tooltipContainer,keyCodes:[a.accessibility.keyCodes.ESC],fn:function(){a.$closeButton.click()}}),a.accessibility.addKeyListener("up",{element:a.$closeButton,keyCodes:[a.accessibility.keyCodes.ENTER],fn:function(){a.$tooltipTrigger.focus()}}),a.accessibility.activateKeyboardTrap({container:a.$tooltipContainer,
...
this.isTablet=this.isMobile=!1}};e._initTooltips=function(){var c=this,a=this.options,m=this.$element,g=this.$tooltip,f=this.$context,e=m.data("position"),k=g.data("open-default"),h=!1,p=m.data("open-onclick"),n=d(".ds2-icon",m).data("tooltip-type"),q=m.data("set-container"),l="top-center"===e?0:10;q="top-center"===e?1==q?d(window):"":d(window);var y=-1<c.tooltipId.indexOf("plcPrice"),z=-1<c.tooltipId.indexOf("tooltip-needanalyzer"),A=-1<c.tooltipId.indexOf("tooltip-dynamic");n||(n=m.data("tooltipType"));
c._isOnLayer()&&(e="layer");switch(e){case "top-center":e="bottom center";var r="top center";var t=a.bottomOffset;break;case "layer":e="left center";r="right center";var u=t=0;break;default:switch(n){case "spotlight":e="center left";r="center right";t=a.bottomOffset;break;case "needanalyzer-sharing-medium-down":e="bottom right";r="top right";t=14;l=-15;u=15;break;case "needanalyzer-sharing-large":e="left top";r="right top";t=40;u=35;break;default:e="left top",r="right top",t=a.dynamicTopOffset}}a=
{solo:!0,ready:h};var v={event:!1};if(y||z||A)v={event:"unfocus",fixed:!0,delay:300};k&&(h=!0,v={event:"click"});if(p||c.fullscreenMode)a={solo:!0,event:"click",ready:h};c.content=g;if(!("spotlight"===n||c.isTablet&&c.isMobile)){var w=!1;m.qtip({overwrite:!0,content:{text:g[0]},style:{tip:{corner:!0,width:20,height:10,offset:u}},position:{container:f,viewport:q,my:e,at:r,adjust:{y:t,x:l}},show:a,hide:v,events:{show:function(a,b){d("[data-qtip-id\x3d'"+b.id+"']",f).css("display","block");d("[data-qtip-id\x3d'"+
b.id+"']",f).addClass("qtip-fadeIn");c.$element.addClass("ds2-tooltip--open")},move:function(a,b){w?setTimeout(function(){w=!1},1E3):(w=!0,a=b.position.my.x+"_"+b.position.my.y,c.lastPosition!==a&&(c.lastPosition=a,c._repositionTooltipCorner(a)))},hide:function(a,b){m.qtip("option","show.ready",!1);m.qtip("option","hide.fixed",!0);m.qtip("option","hide.delay",300);c._body.removeClass("no-scroll");d("[data-qtip-id\x3d'"+b.id+"']",f).css("display","");d("[data-qtip-id\x3d'"+b.id+"']",f).removeClass("qtip-fadeIn");
m.removeClass("ds2-tooltip--open")},visible:function(a,b){c._checkForFullscreen();c._buildFullSize(c.$tooltip,c.fullscreenMode);c.scrollBar.setBarPosition()}}})}d(".ds2-tooltip-element--close a, .qtip-close, .ds2-tooltip-element--close-button",c.content).off().on("click",m,c._onCloseClick);c.$element[0].addEventListener("ds2-tooltip--close",function(){c.$element.qtip("hide")},!1)};e._onCloseClick=function(a){var c=a.data;a.preventDefault();c.qtip("hide")};e._onResize=function(a){a=a.data;var b=a.$element,
...
15));break;case "left_center":case "right_center":c.qtip("option","style.tip.mimic",!1),c.qtip("option","style.tip.offset",0)}},1)};e._createScrollBar=function(){this.scrollBar=new l(this.$tooltip[0])};e._checkForFullscreen=function(){var a=this,b=a.$element,e=a.$tooltip,f=b.data("tooltip-type"),h=b.data("position"),l=d(document).width(),k=e.width()+12+40,x=b.width();b=(b?b.offset():0).left;var p=l-x-b,n=!1,q=!1;k=410<k?410:k;"top-center"===h&&(k=e.width()/2,b+=x/2,p=l-b,b>p?q=!0:n=!0,k=205<k?205:
k);"spotlight"!==f&&"top-center"!==h&&b<=k&&p<=k?a.fullscreenMode=!0:"spotlight"!==f&&"top-center"===h&&(n&&b<=k||q&&p<=k)?a.fullscreenMode=!0:a.isMobile||(a.fullscreenMode=!1);a.iscroll&&(a.iscroll=null);setTimeout(function(){a._createScrollBar()},50)};require(["componentInitializer"],function(a){window.digitals2.tooltips={init:function(b){a.init(d(b))},initAll:function(b){a.initAll(d(b))},initElement:function(b){a.initElement(d(b))},getController:function(b,c){a.getController(d(b),c)}}});return f});